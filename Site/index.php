...
<body>
			...
			<div class="modal-body">
				...
				<div class="register-form tabs-page" id="register-form-tab">
					<form method="POST" action="./php/cadastro.php"	class="form-control" id="frmcadastro" onsubmit="return verificaForm(event)">
						...
						<div class="input-group">
							<span class="fas fa-user"></span> <input type="text"
								name="txtCpf" placeholder="cpf" id="cpf" maxlength="14" class="form_input" onkeydown="javascript: fMasc( this, mCPF );">
						</div>
 ...
 <g id="Camada_x0020_1">
  ...
  <path class="fil0 str0"
	...
	<!--<section> 
        <svg class="svg2" xmlns="http://www.w3.org/2000/svg" xml:space="preserve"  version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd"
