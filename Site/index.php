				...
				<div class="login-form tab-active tabs-page" id="login-form-tab">
					...
					<form action="php/login.php" method="post" class="form-control">
						<div class="input-group">
							...
							<input type="text" placeholder="Seu Email" name="txtUser">
						</div>
						<div class="input-group">
		...
		<nav class="navbar">
			...
			<ul class="ul2">
				<div class="container-nav2">
					...
					<li><a href="<?php echo $link;?>" class="btn-login" onclick="fnModal(this)">
							<?php echo $label;?></a></li>
					<div class="line"></div>
				</div>
			</ul>
		...
		<section class="description section-hidden">
			<div class="container-description description-baue">
				...
				<p>Nosso sistema oferece uma proposta inovadora e beneficente
					para nossos clientes. A plataforma consiste em que o próprio cliente
					monte sua pizza, podendo fazer a combinação que quiser a partir dos
					ingredientes que disponibilizarmos. Conforme o usuário vai montando
					suas pizzas, seu nível de medalhas vai subindo, quando obter um
					número específico de pizzas montadas ou compradas, ele ganha uma
					mega promoção. As pizzas personalizadas de nossos clientes, irão
					para uma página de avaliação, se a pizza difereciada atingir muitas
					estrelas de outros clientes da Pizza Baue, essa pizza pode ir para o
		...
		<section class="sec section-hidden">
			<div class="promos container-slider">
				...
				<div id="slider">
					<ul id="slideWrap">
						<li id="itemsSlider">
							<div class="card">
								...
								<h2>Mussarela</h2>
								<p>Coberta com molho de tomate, queijo tipo mussarela,
									azeitonas pretas e orégano e massa com fermentação natural.</p>
						...
						<li id="itemsSlider">
							<div class="card">
								...
								<h2>Portuguesa</h2>
								<p>Presunto especial acompanhado de cebola e azeitonas
									verdes, coberto pela exclusiva mussarela Pizza Baue.</p>
								<div class="price-card-slider">
									<h3>R$ 30,00</h3>
								</div>
								<button class="btn-slider">Adicionar ao carrinho</button>
						...
						<li id="itemsSlider">
							<div class="card">
								...
								<p>Deliciosas fatias de pepperoni (salame especial
									condimentado com páprica) e mussarela.</p>
								<div class="price-card-slider">
									<h3>R$ 35,00</h3>
								</div>
								<button class="btn-slider">Adicionar ao carrinho</button>
					...
					<a id="prev" class="sliderPrev">&#8810;</a> <a id="next" class="sliderNext">&#8811;</a>
				</div>
			</div>
				...
				<div class="row">
					<div class="inter-row">
						<div class="service-box">
							...
							<p>Uma plataforma em que o cliente pode montar sua própria
								pizza.</p>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="comments">
						...
						<div class="mySlides fade">
							<div class="left">
								...
								<div class="box-comment">
									<br> <br> <br>
									<p>"A proposta é bem diferente do tradicional, bem
										inovadora, tem futuro"</p>
					...
					<div style="text-align: center">
						<span class="dot" onclick="currentSlide(1)"></span> <span class="dot" onclick="currentSlide(2)"></span> <span
	...
	<footer>
		<div class="cont-footer">
			<div class="bloco">
				...
				<p class="bl-conteudo">
					<i class="fas fa-phone ga"></i> +55(11)94631-0146 <i class="fas fa-phone ga"></i> +55(11)95275-0119 <i class="fas fa-phone ga"></i>
					+55(11)94893-2802 <i class="fas fa-phone ga"></i> +55(11)95876-6887 <i class="fas fa-phone ga"></i>
					+55(11)94539-8380
				</p>
			</div>
			<div class="bloco">
			...
			<div class="bloco">
				...
				<p class="bl-conteudo">
					<i class="fab fa-facebook-square gab" alt="Facebook" title="Facebook"></i> <i class="fab fa-instagram gab" alt="Instagram"
					 title="Instagram"></i> <i class="fab fa-twitter gab" alt="Twitter" title="Twitter"></i> <i class="fas fa-envelope gab"
