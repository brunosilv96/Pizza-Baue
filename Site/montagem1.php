...
<head>
	...
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="css/montagem1.css">
</head>
<body>
<section class="montagem">
	<form name="frmMontagem">
		...
		<div id="etapa1" class="etapa1">
			...
			?>
			<div class="botoes">
			<a href="index.php"><button type="button" id="btn1" class="botao">Inicio</button></a>
		...
		<div class="etapa0">
		    <button type="button" id="btn1" class="botoes" onclick="visualizaDiv(1)">Monte sua pizza</button>
...
<script src="js/montagem1.js"></script>
</html>