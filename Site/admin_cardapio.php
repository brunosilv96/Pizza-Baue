...
<body>
        <div class="container-conteudo">
                <h3>Inserir Pizza</h3>
                <form action="php/atualizaTelefone.php" method="post" id="telefone"
                        onsubmit="return verificaEnde(event)">
                        <table>
                                <tr>
                                ...
                                <tr>
                                        <td class="txt"><input type="text" id="log" class="input-cadastro" name="txtNome"></td>
                                </tr>
                                ...
                                <tr>
                                        ...
                                        <td class="txt" name="txtDescricao"><textarea></textarea></td>
                                </tr>
